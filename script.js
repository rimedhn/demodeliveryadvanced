// Ajuste: sincroniza la navegación inferior en móvil (.footer-app-menu) y superior en escritorio (.app-menu)
// El resto del JS se mantiene igual, solo se actualiza la navegación para ambas barras
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Unifica la navegación para escritorio y móvil
  function handleMenuClick(btn) {
    document.querySelectorAll('.app-menu button, .footer-app-menu button').forEach(b => b.classList.remove('active'));
  ...
  document.querySelectorAll('.app-menu button, .footer-app-menu button').forEach(btn => {
    btn.onclick = function() { handleMenuClick(btn); };
  });
  ...
  document.getElementById("start-order-btn").onclick = function() {
    ...
    document.querySelectorAll('.app-menu button, .footer-app-menu button').forEach(b => b.classList.remove('active'));
    document.querySelectorAll('.app-menu button[data-section="order-stepper"], .footer-app-menu button[data-section="order-stepper"]').forEach(b => b.classList.add('active'));
    initStepper();
